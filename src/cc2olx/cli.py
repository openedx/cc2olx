...
def parse_args(args=None):
    parser = argparse.ArgumentParser(
        description="This script converts imscc files into folders with "
    ...
    parser.add_argument(
        ...
        required=True,
        help="Please provide the paths to the imscc files or directories "
        "that contain them.",
    )
    parser.add_argument(
        "-ll",
        ...
        default="INFO",
        help="Please provide the appropriate level to change the detail of "
    ...
    parser.add_argument(
        ...
        help="Please provide the way in which final result "
